...
Insere a palavra a ser cadastrada no banco. Onde termoASerCadastrado é a palavra a ser inserida no baco, ou seja, será o parâmetro.

http://localhost:8080/OLXCostDistanceRest/challenge4/getmindistance?name=[termo]&threshold=[numero]
